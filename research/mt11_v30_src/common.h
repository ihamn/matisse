...
#define KERNEL_PAGE_SETUP_ATTEMPTS 5
...
#define PSELECT_CFI_ROUTE_ATTEMPTS 5
...
extern atomic_int waiter_blocked;
extern atomic_int owner_started;
extern atomic_int owner_chain_done;
extern atomic_int route_done;
extern atomic_int owner_release_go;
extern atomic_int pselect_ready;
extern atomic_int pselect_tid;
