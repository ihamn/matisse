...
LOG=/sdcard/Documents/matisse_backup_essentials/logs/mt18_oracle.txt
...
echo "=== [3/4] 运行 (oracle: tree_pc=未映射, ONE_SHOT, shift=0) ==="
...
LD_PRELOAD=$DST /system/bin/sleep 30 2>&1 | tee -a $LOG
RC=$?
