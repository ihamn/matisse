...
LOG=/sdcard/Documents/matisse_backup_essentials/logs/mt21_bootid.txt
RUNLOG=/data/local/tmp/mt21_run.out
...
for ATT in 1 2 3; do
  ...
  grep -a 'mt21: stamp\|mt19b: sched\|SLIDE page\|bad leaked\|stext=\|collision finding failed\|leak retry' $RUNLOG | sed 's/\x1b\[[0-9;]*m//g' >> $LOG
